...
$sendingAccountUsername     = 'jordy.guntur@gmail.com';
...
$websiteName                = 'SneakVert Society';                // REQUIRED value. This is used when a name or email is not collected from the website form
