              ...
              <div class="container">
                  <div class="row justify-content-center no-gutters">
                      <div class="col-md-8 col-lg-7">
                          <form class="text-left form-email row mx-0" data-success="Thanks for your enquiry, we'll be in touch shortly." data-error="Please fill in all fields correctly." data-recaptcha-sitekey="6Ld4P6AUAAAAAPXtcN-wyZomHKUv_sFnUfsiLofB" data-recaptcha-theme="light">
                              <div class="col-md-6">
          ...
          <footer class="text-center-xs space--xs ">
              <div class="container">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-5 text-right text-center-xs">
                          <a class="type--fine-print" href="#">info@sneakvertsociety.com</a>
                      </div>
                  </div>
                  <!--end of row-->
              </div>
